...
import io.github.gclipse.testing.EclipseTestExecuter
 ...
 * defined in the {@link io.github.gclipse.testing} package.
 * <p/>
...
class TestBundlePlugin implements Plugin<Project> {
    ...
    static void configureProject(Project project) {
        ...
        project.getPlugins().apply(io.github.gclipse.BundlePlugin)
